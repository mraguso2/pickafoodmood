...
const NoLocations = () => (
  <div className="flex flex-col justify-center">
    <div className="w-48 p-2 flex items-center justify-center addLocationButton">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
        className="w-6 mr-3 icon-add-circle"
      >
    ...
    <p className="w-64 mt-8 font-light">
      You don't have any locations saved <br /> Go out and eat!
    </p>
    <svg
      xmlns="http://www.w3.org/2000/svg"
    ...
    >
      <defs>
        ...
        <linearGradient
          ...
          x2="381.42"
          y2="312.18"
          xlinkHref="#a8b3c97d-e0d9-42bd-b729-a4d45980fc6b"
        />
      </defs>
      ...
      <path
        ...
        fill="#4c51bf"
      />
      <rect x="265.44" y="402.64" width="13.59" height="194.86" fill="#40414d" />
      <rect x="562.26" y="402.64" width="13.59" height="194.86" fill="#40414d" />
      <path
      ...
      <rect
        ...
        fill="#40414d"
      />
      <rect x="152.17" y="503.59" width="11.89" height="108.18" fill="#40414d" />
      <rect x="246.08" y="503.59" width="11.89" height="108.18" fill="#40414d" />
      <path
